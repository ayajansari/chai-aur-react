...
// function Card(props){  this is also fine , we can access values by props.username,etc.
function Card({ username, btnText = "visit me" }) {
  //object destructuring done
  //visit me is the default value to btnText if not containing any value then used
